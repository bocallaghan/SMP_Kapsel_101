...
sap.m.InputRenderer.writeInnerAttributes=function(r,c){r.writeAttribute("type",c.getType().toLowerCase());if(!c.getEnabled()&&c.getType()=="Password"){r.writeAttribute("readonly","readonly")}};
